...
railway track (i.e., to emulate the scheduling of multiple
threads sharing a common resource in a real OS).

There are two stations on each side of the main track.
...
You shall implement your solution in `C` programming language only.
